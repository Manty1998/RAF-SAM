...
class Sam_dualmask_same_prompt_class_random_large(nn.Module):
    ...
    def forward_train(self, batched_input, multimask_output, image_size, prompt_idx, prompt):
        ...
        if prompt_idx == 0:
            ...
            low_res_masks1, iou_predictions1, dense_features1, consistency_loss1 = self.mask_decoder1(
            ...
            low_res_masks2, iou_predictions2, dense_features2, consistency_loss2 = self.mask_decoder2(
                image_embeddings=image_embeddings,
                image_pe=self.prompt_encoder.get_dense_pe(),
                sparse_prompt_embeddings=sparse_embeddings,
                dense_prompt_embeddings=dense_embeddings,
            ...
            low_res_masks2_r, iou_predictions2_r, dense_features2_r, consistency_loss2_r = self.mask_decoder2(
                image_embeddings=image_embeddings,
                image_pe=self.prompt_encoder.get_dense_pe(),
            ...
            low_res_masks1_r, iou_predictions1_r, dense_features1_r, consistency_loss1_r = self.mask_decoder1(
                image_embeddings=image_embeddings,
                image_pe=self.prompt_encoder.get_dense_pe(),
                sparse_prompt_embeddings=sparse_embeddings_r,
                dense_prompt_embeddings=dense_embeddings,
        ...
        total_consistency_loss = consistency_loss1 + consistency_loss2 + consistency_loss1_r + consistency_loss2_r
        ...
        if prompt_idx != -1:
            if prompt_idx == 1:
                outputs = {
                    ...
                    'total_consistency_loss': total_consistency_loss  # 新增项
                }
            else:
                outputs = {
                    'masks': masks1,
                    ...
                    'total_consistency_loss': total_consistency_loss    # add
                }
        else:
            outputs = {
                'masks': masks1,
