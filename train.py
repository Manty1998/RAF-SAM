...
parser.add_argument('--output', type=str, default='output/main')
...
parser.add_argument('--labeled_num', type=int, default=3, help='labeled data')  # determine the number of labeled data
parser.add_argument('--warm_iter', type=int, default=5000,help='labeled data')
parser.add_argument('--method', type=str, default='20241004KAN')
...
parser.add_argument('--consistency_frequency', type=float, default=0.1, help='Consistency frequency weight')
